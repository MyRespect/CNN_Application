...
def Generator():
    ...
    skips = reversed(skips[:-1])  # exclude last layer and then reverse order.
...
def train(dataset, epochs, generator, discriminator):
    for epoch in range(epochs):
        ...
        print ('Time taken for epoch {} is {} sec\n'.format(epoch + 1,
                                                            time.time() - start))
    tf.saved_model.save(generator, './pix2pix/generator')
    tf.saved_model.save(discriminator, './pix2pix/discriminator')
